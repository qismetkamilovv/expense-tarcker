...
@Configuration
@OpenAPIDefinition(info = @Info(title = "Expense-Tracker", version = "v1", description = "Documentation of Spring Boot API"), security = @SecurityRequirement(name = "bearerAuth"))
